...
<head>
    ...
    <title>Metodo de Abono</title>
    <link rel="stylesheet" href="../../../public/css/Usuario/metodo_abono.css">
        ...
        <div id="principal">
            ...
            <div id="contenido-a-actualizar">
                <div class="contenido">
                    ...
                    <br>
                    <button type="button" class="efectivo" data-toggle="modal"
                        data-target="#modal-agregar">Efectivo</button>
                </div>
            </div>
            <?php include("../../model/modals/modalEfectivo.php") ?>
            <?php
